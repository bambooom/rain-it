...
function generateEmojiDrops(mode = EMOJI_MODE.SINGLE) {
    ...
    switch (mode) {
        case EMOJI_MODE.SINGLE:
            {
                const emoji = getEmojiFromCodePoint(EMOJI_CODE[Math.floor(Math.random() * EMOJI_NUMBER)]);
